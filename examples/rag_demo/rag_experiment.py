...
def run_rag_demo() -> None:
    ...
    documents = [
        {
            "id": 1,
            "text": (
                "The Project Titan manual states that the emergency override code "
                "is 'APPLE-BLUE-2026'."
            ),
        ...
        },
        {
            "id": 2,
            "text": (
                "The secure server room is located on the 4th floor, behind the glass "
                "partition in Sector 7G."
            ),
        ...
        },
        {
            "id": 3,
            "text": (
                "Employee of the month for April 2026 is Sarah Jenkins from the "
                "Neural Engine optimization team."
            ),
    ...
    context = "\n".join([str(res.payload["text"]) for res in search_result])
    print("\n--- Retrieved Context ---")
    print(context)
    print("-------------------------\n")
