...
def validate_embeddings():
    sentences = [
        ...
        ("The stock market is volatile today.", "I enjoy eating green apples."), # Dissimilar
        ("Apple Intelligence is coming to Mac.", "The weather is nice in Cupertino.") # Slightly related
    ]
